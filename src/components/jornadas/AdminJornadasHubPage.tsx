...
const hubLinks: HubLink[] = [
  ...
  {
    to: '/jornadas/iii-jornada/comite-preview',
    title: 'Vista previa del comité',
    description: 'Panel simulado de presidencia y vicepresidencia para revisión visual.',
    icon: FileText,
    mode: 'mock',
    badge: 'Mock / revisión visual',
  },
  {
    to: '/jornadas/iii-jornada/evaluacion-preview',
    title: 'Vista previa del evaluador',
    description: 'Panel ciego simulado, sin autoría, archivos ni persistencia.',
    icon: Eye,
    mode: 'mock',
    badge: 'Mock / revisión visual',
  },
